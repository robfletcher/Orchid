...
constructor(context: OrchidContext) : Theme(context, "BsDoc", 100) {
    ...
    override fun loadAssets() {
        ...
        addCss(AssetPage(this, "theme", context.getResourceEntry(this, "https://netdna.bootstrapcdn.com/bootstrap/3.3.1/css/bootstrap.min.css"), "bootstrap.min"))
        addCss(AssetPage(this, "theme", context.getResourceEntry(this, "https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css"), "font-awesome.min"))
